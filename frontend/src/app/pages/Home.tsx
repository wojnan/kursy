...
export function Home() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-gradient-to-br text-white py-20" style={{ backgroundImage: 'linear-gradient(to bottom right, #4F772D, #3d5a22)' }}>
        <div className="container px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              <Link to="/courses">
                <Button size="lg" variant="secondary" className="gap-2 bg-amber-50 hover:bg-amber-100" style={{ color: '#1a3a0f' }}>
                  Explore Courses <ArrowRight className="h-4 w-4" />
                </Button>
              </Link>
              <Link to="/dashboard">
                <Button size="lg" variant="outline" className="bg-transparent border-white text-white hover:bg-white" style={{ '--hover-color': '#4F772D' } as any}>
                  My Learning
                </Button>
              </Link>
            </div>
      ...
      <section className="py-20 text-white" style={{ backgroundColor: '#4F772D' }}>
        <div className="container px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Join thousands of students already learning on LearnHub. Get started with a course today.
          </p>
          <Link to="/courses">
            <Button size="lg" variant="secondary" className="gap-2 bg-amber-50 hover:bg-amber-100" style={{ color: '#1a3a0f' }}>
